...
class VidCLIP(nn.Module):
    ...
    def forward(self, video, image_tensor , text_input_ids, text_input_mask, \
        ...
        if self.vision_additional_config.type == "ViP":
            ...
            results = {}
            results["text_features1"] = outputs["text_embeds1"]
            results["vis_features1"] = outputs["image_embeds1"]
            results["text_features2"] = outputs["text_embeds2"]
            results["vis_features2"] = outputs["image_embeds2"]
            results["conf_weights"] = outputs["conf_weights"]
