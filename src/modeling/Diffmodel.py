...
from src.modeling.co_attention_transformer_module import Transformer
...
class StochasticText(nn.Module):
    ...
    def forward(self, images = None , text_features = None):
        """
        Input
        ...
        text_features = self.pool_frames( text_features , log_var )
